...
const Page = () => {
  ...
  const { token, setOneVoucherId }: any = useGeneralContext();
  ...
  const onSubmit = async (e: any) => {
    try {
      ...
      setOneVoucherId(response.data.data.voucher.id);
  ...
  return (
    <>
      <div className="flex flex-col gap-4 justify-start w-[96%] mx-auto">
        {/* breadcumb */}
