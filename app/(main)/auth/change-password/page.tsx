...
const Page = () => {
  ...
  const onchangeHandler = async (e: any) => {
    e.persist();
    setChangePasswordDetails((item: any) => ({
      ...item,
              ...
              <div className="flex flex-col gap-4 pt-auto justify-start">
                {authLoading ? (
                  ...
                  <button
                    ...
                    className="transition-fx w-auto xl:w-[353px] h-[44px] capitalize hover:bg-brand-main/20 cursor-pointer rounded-3xl flex items-center justify-center text-brand-white bg-brand-main"
                  >
                    PROCEED
                  </button>
                )}
