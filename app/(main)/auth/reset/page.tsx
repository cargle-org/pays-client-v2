...
const Page = () => {
  ...
  const onchangeHandler = async (e: any) => {
    e.persist();
    setResetPasswordDetails((item: any) => ({
      ...item,
  ...
  useEffect(() => {
    ...
    const fetchedResetToken = urlParams.get("resetToken") as any;
    setResetPasswordDetails((item: any) => ({
      ...item,
      id: fetchedId,
      resetToken: fetchedResetToken,
    }));
  }, []);

  //  useEffect(() => {
  //    if (resetPasswordDetails.id) handleVerifyEmail();
  //  }, [resetPasswordDetails]);
