    ...
    <div className='w-full'>
      ...
      <div className='hidden fixed bg-brand-white z-50 w-full items-center justify-between py-2 px-8 border-[0.1px] pb-4 border-b-brand-gray100 lg:flex'>
        ...
        <div className='flex items-center justify-evenly gap-10 mt-2'>
          <Link
            href={"/"}
            className={`transition-fx nav-hover-fx capitalize text-base font-geistsans ${
              isActive("/") ? "text-brand-main font-semibold" : "text-brand-grayish font-light"
          ...
          {/* <Link
            href={"/about"}
            className={`transition-fx nav-hover-fx capitalize text-base font-geistsans ${
              isActive("/about") ? "text-brand-main font-semibold" : "text-brand-grayish font-light"
            } hover:text-brand-main`}>
            About
          </Link> */}
          <Link
            href={"/faqs"}
            className={`transition-fx nav-hover-fx capitalize text-base font-geistsans ${
              isActive("/faqs") ? "text-brand-main font-semibold" : "text-brand-grayish font-light"
            } hover:text-brand-main`}>
            FAQs
          </Link>
          <Link
            href={"/privacy"}
            className={`transition-fx nav-hover-fx capitalize text-base font-geistsans ${
              isActive("/privacy") ? "text-brand-main font-semibold" : "text-brand-grayish font-light"
            } hover:text-brand-main`}>
            Privacy
          </Link>
          <Link
            href={"/business"}
            className={`transition-fx nav-hover-fx capitalize text-base font-geistsans ${
              isActive("/business") ? "text-brand-main font-semibold" : "text-brand-grayish font-light"
            } hover:text-brand-main`}>
            Business on Usepays
          </Link>
        </div>
