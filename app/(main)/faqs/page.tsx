...
const Faqs = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can e-mail us at hi@usepays.co or give us a call at +2347034560055 for any inquiries or assistance.",
    },
    {
    ...
    },
    {
      ...
      answer: "Cashing out a voucher is instant once the recipient follows the provided instructions.",
    },
    {
      question: "Do vouchers have an expiration date?",
      answer: "Please check the specific terms of each voucher, as expiration dates may vary.",
    },
    {
          ...
          {faqs.map((faq, index) => (
            <div key={index} className='border border-gray-200 rounded-lg overflow-hidden'>
              <button
                ...
                <span className={`${openIndex === index ? "font-bold" : "font-medium"}`}>{faq.question}</span>
      ...
      <div className='col-span-12 flex items-center justify-center gap-2 text-xl font-medium mt-8'>
        ...
        <div className='group items-center text-xs font-semibold gap-2 cursor-pointer'>
          <span className='text-brand-main text-xl font-medium relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-current after:transition-all after:duration-300 group-hover:after:w-full'>
            <a href='mailto:support@usepays.co' target='_blank' rel='no_referrer'>
              Contact Us
            </a>
          </span>
        </div>
