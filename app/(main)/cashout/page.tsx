...
import VoucherSuccessAnimation from "@/components/VoucherSuccessAnimation";
...
const Page = () => {
  ...
  return (
    <>
      <div
        className={`w-full min-h-screen pt-16 pb-12 flex items-start justify-center gap-8 lg:pt-32 ${
          showVoucherSuccessAnimation && "bg-black bg-opacity-90 z-50"
        }`}
      >
        <div
        ...
        >
          {showVoucherSuccessAnimation && (
            <VoucherSuccessAnimation voucherBg={oneVoucher?.backgroundStyle} />
          )}
          {!showVoucherSuccessAnimation && (
