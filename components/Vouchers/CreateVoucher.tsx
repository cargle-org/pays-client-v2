...
import VoucherTemplates from "@/components/Vouchers/VoucherTemplates";
...
interface CreateVoucherProps {
  ...
  formData: VoucherDataProps;
  setFormData: Dispatch<SetStateAction<VoucherDataProps>>;
  handleCreateVoucherDraft?: (e: React.MouseEvent) => Promise<void>;
}
      ...
      <div className="max-w-xl lg:max-w-[2560px] flex flex-col gap-3.5 justify-start w-full mx-auto">
        ...
        <div className="flex items-center justify-between ">
          <div className="flex items-center gap-2 font-geistsans font-normal text-[10px] text-brand-grayish">
            <Link
              href={isGuest ? "/guest/create-voucher" : "/dashboard/vouchers"}
        ...
        >
          ...
          <div className="flex flex-col w-full lg:w-[50%]">
            ...
            <div className="rounded-b-xl bg-brand-white p-4 flex justify-between items-center border border-brand-grayish/15">
              <Link
                href={isGuest ? "/guest/welcome" : "/dashboard/vouchers"}
